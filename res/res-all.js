...
const statisticList = {
	...
	'9-12-ai': '<thead><tr class="table-success"><th scope="col">Total Participates</th><th scope="col">Total School</th><th scope="col">Grade 9</th><th colspan="col">Grade 10</th><th colspan="col">Grade 11</th><th colspan="col">Grade 12</th></tr></thead>' + '<tr><td>181</td><td>68</td><td>39</td><td>42</td><td>60</td><td>40</td></tr>',
	'9-12-game': '<thead><tr class="table-success"><th scope="col">Total Participates</th><th scope="col">Total School</th><th scope="col">Grade 9</th><th colspan="col">Grade 10</th><th colspan="col">Grade 11</th><th colspan="col">Grade 12</th></tr></thead>' + '<tr><td>261</td><td>155</td><td>77</td><td>69</td><td>60</td><td>65</td></tr>',
	'9-12-cyber': '<thead><tr class="table-success"><th scope="col">Total Participates</th><th scope="col">Total School</th><th scope="col">Grade 9</th><th colspan="col">Grade 10</th><th colspan="col">Grade 11</th><th colspan="col">Grade 12</th></tr></thead>' + '<tr><td>88</td><td>46</td><td>20</td><td>32</td><td>21</td><td>15</td></tr>',
	'9-12-mobile': '<thead><tr class="table-success"><th scope="col">Total Participates</th><th scope="col">Total School</th><th scope="col">Grade 9</th><th colspan="col">Grade 10</th><th colspan="col">Grade 11</th><th colspan="col">Grade 12</th></tr></thead>' + '<tr><td>109</td><td>68</td><td>31</td><td>52</td><td>16</td><td>20</td></tr>',
	'9-12-application': '<thead><tr class="table-success"><th scope="col">Total Participates</th><th scope="col">Total School</th><th scope="col">Grade 9</th><th colspan="col">Grade 10</th><th colspan="col">Grade 11</th><th colspan="col">Grade 12</th></tr></thead>' + '<tr><td>150</td><td>79</td><td>36</td><td>44</td><td>36</td><td>34</td></tr>',
}
const levelList = {
	'k-3': 'Grade K - 3',
	'4-6': 'Grade 4 - 6',
